...
import { devTestDomainLogic2 } from '../domain/dev-test-domain-logic-2';
import { DevTestEvent } from '../domain/events';

@CommandHandler(DevTestCommand2ApplicationCommand)
export class DevTestCommand2ApplicationCommandHandler {
  private readonly logger = new Logger(DevTestCommand2ApplicationCommandHandler.name);
  ...
  async execute(command: DevTestCommand2ApplicationCommand): Promise<void> {
