...
const fullHarmonogram = <InternalLink href="#">pełnym harmonogramie CodersCamp</InternalLink>;
...
export const questions: Question[] = [
  {
    ...
    content: (
      <>
        Kurs łączy w sobie pracę indywidualną (przerabianie materiałów) oraz pracę zespołową (tworzenie projektów). Czas
        przerabiania materiałów możesz w pełni dostosować do swoich potrzeb. W przypadku pracy projektowej wszystko
        zależy od ustaleń, jakie wypracujesz wspólnie ze swoim zespołem — ze swojej strony nie narzucamy odgórnie formy,
        czasu, ani częstotliwości spotkań zespołowych. Spotkania organizacyjne oraz testy organizowane są zawsze o
        godzinie {MAIN_TEST_HOUR}, a ich dokładne rozmieszczenie możesz zobaczyć w {fullHarmonogram}.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        Pełny harmonogram zapisów na CodersCamp znajdziesz <InternalLink href="#">w tej sekcji</InternalLink>. Możesz
        także{' '}
        <Button variant="link" color="brand">
          kliknąć tutaj
        </Button>{' '}
        i podać nam swój adres e-mail a przypomnimy Ci o rozpoczęciu rekrutacji.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Ze względu na {TEAM_SIZE}-osobową liczebność zespołów liczba miejsc na kursie to: {TEAM_SIZE} * liczba mentorów.
        Aktualnie możemy przyjąć na kurs {PLACES_COUNT} osób. Pamiętaj jednak, że do rozpoczęcia CodersCamp ta wartość
  ...
  },
  {
    ...
    content: (
      <>
        ...
        Discord, na którym znajdują się wszystkie osoby zapisane na CodersCamp — możesz wykorzystać to do zorganizowania
        zespołu projektowego na własną rękę.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <InternalLink href="#">szczegóły tutaj</InternalLink>). Możesz także otrzymać link do formularza na swoją
        skrzynkę e-mail w pierwszym dniu rekrutacji. W tym celu{' '}
        <Button variant="link" color="brand">
          kliknij tutaj
        </Button>{' '}
        i zostaw nam swój mail.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <InternalLink href="#">planie kursu</InternalLink>.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Niestety test kwalifikacyjny na CodersCamp odbywa się tylko raz w ściśle określonym terminie 😕 Jeśli nie uda Ci
        się na nim pojawić, nie będziesz miał szansy, aby dostać się na kurs.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        developerem i nie znasz dobrze Node.js) będziesz miał ponad 2 miesiące na uzupełnienie braków. Oczywiście w tym
        czasie możesz liczyć na pełną pomoc ze strony nas oraz innych mentorów.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Bez problemu. Jeśli nie czujesz, że Twoje predyspozycje czasowe wystarczają, aby prowadzić zespół samodzielnie,
        daj nam znać. Przypiszemy Cię do zespołu razem z innym mentorem o podobnej preferencji. Jeśli masz już na myśli
        kogoś konkretnego, z kim chciałbyś prowadzić zespół, również daj nam znać.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        Testy sprawdzające wiedzę są obowiązkowe i nie posiadają drugich terminów. W związku z tym upewnij się, że dasz
        radę podejść do każdego z testów, sprawdzając ich terminy w {fullHarmonogram}.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        Nie, cały kurs jest w pełni darmowy. W ramach materiałów odnajdziesz czasami polecane przez nas źródła, które są
        płatne, niemniej ich zakup nie jest wymagany do ukończenia kursu.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        zarówno mentorzy, jak i osoby zajmujące się organizacją kursu, które angażują się w CodersCamp w pełni pro bono.
        Dodatkowo wszystkie koszty kursu, których nie da się uniknąć (np. utrzymanie serwerów, wykorzystywane
  ...
  },
  {
    ...
    content: (
      <>
        Podczas kursu możesz liczyć na wiele materiałów i szkoleń, które pomogą Ci w poszukiwaniu pracy. Dla najlepszych
        przewidujemy także konsultacje CV oraz próbne rozmowy rekrutacyjne. Innymi słowy, dajemy różne możliwości,
        których odpowiednie wykorzystanie zależy już tylko od Ciebie. Nie pośredniczymy w żaden sposób w znalezieniu dla
        Ciebie pracy.
      </>
    ),
  },
